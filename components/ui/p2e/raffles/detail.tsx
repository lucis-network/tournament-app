...
const RafflesDetail = () => {
  ...
  return (
    <div className={s.rafflesDetailWrapper}>
      <section className={s.sectionBreadcrumb}>
          ...
          <section className={`${s.buyTicketSection} ${s.sidebarSection}`}>
            ...
            <div className={s.buyTicketInfo}>
              <div className={s.buyTicketInfoItem}>
                ...
                <div className={s.buyTicketInfoValue}>3450</div>
              </div>
            </div>
          </section>
          <section className={s.rafflesRollingSection}>
            ...
            <table>
              <tbody>
                <tr className={s.allTicketItem}>
                  <td className={s.numericalOrder}>1</td>
                  <td className={s.ownerAvatar}>
                    <Image src="" preview={false} alt="" fallback="/assets/P2E/raffles/defaultAvatar.jpg" />
                  </td>
