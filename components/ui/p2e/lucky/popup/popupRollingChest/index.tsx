...
const PopupRollingChest = (props: Props) => {
  ...
  const styles = useMemo(() => {
    ...
    const itemElement: Element | null =
      sliderContainer!.querySelector(".rollingItem");
    const itemWidth = itemElement
    ...
    const txOfRollingBlock =
      rollOverBlockCount * prizeShuffled.length * totalItemWidth;
      ...
      >
        <div className={s.container}>
          <div className={s.bg_rolling}>
            <img
              src="/assets/P2E/lucky-chest/bg_rolling.png"
              alt=""
              className={s.bg_rolling_pc}
            />
            <img
              src="/assets/P2E/lucky-chest/bg_rolling_mobile.png"
              alt=""
              className={s.bg_rolling_mobile}
            />
            <div className="rollingContainer">
              <div className={`${s.rolling} rollingEvent`} style={styles}>
                    ...
                    >
                      <div className={s.prizeImg}>
                        <Img
                          ...
                          srcFallback="/assets/P2E/lucky-chest/im_box.png"
                        />
                      </div>
                      <div className={s.title}>
                        <p>{getPrizeTitle(prize)}</p>
                      </div>
                    </div>
                  ));
                })}
